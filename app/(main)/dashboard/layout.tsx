...
export default function DashboardLayout({
    ...
    return (
      ...
      <nav className="border-r dark:border-gray-800 bg-gray-100/40 dark:bg-gray-800/40">
        <div className="flex flex-col gap-2 h-full justify-between">
          <div>
            <div className="flex items-center h-16 px-4 border-b dark:border-gray-800 justify-between">
              <Link className="flex items-center gap-2 font-semibold" href="#">
                <Brain className="h-6 w-6" />
                <span>NagaAI</span>
              </Link>
              <span className="text-gray-500 dark:text-gray-400">Version 3.0</span>
            </div>
        ...
        <header className="flex items-center h-16 px-4 border-b dark:border-gray-800">
          <form className="flex-1">
            <div className="relative">
              ...
              <Input className="pl-8 w-full bg-white dark:bg-gray-950" placeholder="Search..." type="search" />
            </div>
          </form>
